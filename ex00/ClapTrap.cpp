...
ClapTrap::ClapTrap() :   _name("Default_Target"),
                        _hitPoints(10),
                        _energyPoints(10),
                        _attackDamage(0) {
    std::cout << "ClapTrap " << _name << " called the default constructor\n";
}
...
ClapTrap::ClapTrap(const std::string &name) :   _name(name),
                                                ...
                                                _energyPoints(10),
                                                _attackDamage(0) {
    std::cout << "ClapTrap " << _name << " the parameterized constructor was called.\n";
}
...
ClapTrap::ClapTrap(const ClapTrap &ct) :    _name(ct._name),
    ...
    std::cout << "ClapTrap " << _name << " the copy constructor was called.\n";
}
...
ClapTrap &ClapTrap::operator=(const ClapTrap &ct) {
    ...
    std::cout << "ClapTrap " << _name << " the copy assignment operator was called.\n";
    return *this;
}
